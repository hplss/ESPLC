...
class Ladder_VAR : public Ladder_OBJ_Logical
{
	...
	Ladder_VAR( float *value, const String &id = "" ) : Ladder_OBJ_Logical( id, TYPE_VAR_FLOAT ){ values.f.val_ptr = value; b_usesPtr = true; }
	...
	Ladder_VAR( float value, const String &id = "" ) : Ladder_OBJ_Logical( id, TYPE_VAR_FLOAT ){ values.f.val = value; b_usesPtr = false; }
